...
exports.createLevelInstance = async (hackmac, levelAddress, player, levelInstanceClass, params) => {
  return new Promise(async function(resolve, reject) {
    const data = params || {from: player}
    const tx = await hackmac.createLevelInstance(levelAddress, data);
...
exports.submitLevelInstance = async (hackmac, levelAddress, instanceAddress, player, params) => {
  return new Promise(async function(resolve) {
    const data = params || {from: player}
    const tx = await hackmac.submitLevelInstance(instanceAddress, data);
